...
export default function LoginScreen() {
  ...
  const onSubmit = async (values: LoginFormValues) => {
    ...
    try {
      ...
      showAlert(t('auth.loginFailed'), error instanceof Error ? error.message : t('common.tryAgain'));
    } finally {
  ...
  return (
    <Screen>
      <View className="pt-20">
        ...
        <View className="mt-4">
          <Button title={t('auth.logIn')} onPress={handleSubmit(onSubmit)} loading={isSubmitting} />
        </View>
